...
#> Rows: 1,000
#> Columns: 6
#> $ title     <chr> "13F-HR - Tri-Star Advisors Inc. (0001821289) (Filer)", "...
#> $ date      <dttm> 2020-08-18 15:08:19, 2020-08-18 15:02:49, 2020-08-18 14:...
#> $ link      <chr> "https://www.sec.gov/Archives/edgar/data/1821289/00018212...
#> $ cik       <chr> "0001821289", "0001395213", "0001395213", "0001395213", "...
#> $ form_type <chr> "13F-HR", "6-K", "6-K", "6-K", "10-Q", "6-K", "6-K", "13F...
#> $ ticker    <chr> "None", "EDN", "EDN", "EDN", "None", "EDN", "USAS", "None...
```
...
#> Rows: 110
#> Columns: 22
#> $ symbol                <chr> "VENUSD", "BCCOINUSD", "ATMUSD", "BLOCKUSD", ...
#> $ name                  <chr> "VeChain USD", "BitConnect Coin USD", "ATMCha...
#> $ price                 <dbl> 0.11546010, 0.03362903, 0.00007597, 1.3020548...
#> $ changes_percentage    <dbl> -4.46, -14.24, 0.00, -19.39, -3.28, -97.29, -...
#> $ change                <dbl> -0.00539107, -0.00558546, 0.00000000, -0.3132...
#> $ day_low               <dbl> 0.11424368, 0.03327839, 0.00007597, 1.3020548...
#> $ day_high              <dbl> 0.12176445, 0.03963807, 0.00007597, 1.6466447...
#> $ year_high             <dbl> 0.25831330, 0.06102869, 0.02260000, 4.3732100...
#> $ year_low              <dbl> 0.04083622, 0.00557612, 0.00007597, 0.5309521...
#> $ market_cap            <dbl> 8270951, 3270747, 759730, 9153998, 438433824,...
#> $ price_avg50           <dbl> 0.09785710, 0.01842272, 0.01950000, 1.3597058...
#> $ price_avg200          <dbl> 0.08679361, 0.02188870, 0.01950000, 1.4144092...
#> $ volume                <dbl> 206088, 102556, 0, 22385, 224010384, 0, 48135...
#> $ avg_volume            <dbl> 137852, 62513, 93337, 27533, 50312559, 0, 465...
#> $ exchange              <chr> "CRYPTO", "CRYPTO", "CRYPTO", "CRYPTO", "CRYP...
#> $ open                  <dbl> 0.12085117, 0.03921449, 0.00007597, 1.6153003...
#> $ previous_close        <dbl> 0.12085117, 0.03921449, 0.00007597, 1.6153003...
...
#> $ shares_outstanding    <dbl> 71634712, 97259630, 10000394893, 7030425, 102...
#> $ timestamp             <dbl> 1597778598, 1597778598, 1597778598, 159777859...
```
